-- =============================================================================
-- FishBill Database Schema — Migration 001
-- Full schema (32 tables). All statements are idempotent (CREATE TABLE IF NOT EXISTS).
-- Do NOT add CREATE DATABASE or USE statements — the runner connects to the DB directly.
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  `afm`                    varchar(9)    COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `business_settings` (
  ...
  `email_provider`       varchar(30)  COLLATE utf8mb4_unicode_ci DEFAULT 'smtp',
  ...
  `sms_provider_type`    varchar(30)  COLLATE utf8mb4_unicode_ci DEFAULT 'infobip',
...
CREATE TABLE IF NOT EXISTS `ospa_submissions` (
  `id`                char(36)     COLLATE utf8mb4_unicode_ci NOT NULL,
  `business_id`       char(36)     COLLATE utf8mb4_unicode_ci NOT NULL,
  `submission_period` varchar(20)  COLLATE utf8mb4_unicode_ci NOT NULL,
